...
async function updateProjectAIStatus(projectId, updateData, req, res, successMessage) {
    try {
...
router.put('/:id/ai-status', authenticateToken, async (req, res) => {
    ...
    if (command !== undefined)
        updateData.aiCommand = command;
    if (result !== undefined)
        updateData.aiResult = result;
    if (duration !== undefined)
        updateData.aiDuration = duration;
